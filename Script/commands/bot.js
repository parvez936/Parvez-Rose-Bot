...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "parvez") || (event.body.toLowerCase() == "Parvez bai") || (event.body.toLowerCase() == "@P.I.USAMA12") || (event.body.toLowerCase() == "পারভেজ")) {
     return api.sendMessage("পারভেজ বস এখন ব্যস্ত আছেন, যা বলার আমাকে বলেন, পারভেজ বসকে মেনশন দিয়ে...? 😜",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Parvez ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 parvez.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/P.I.USAMA12\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:🇵 🇦 🇷 🇻 🇪 🇿 ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস পারভেজ আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is 🇵 🇦 🇷 🇻 🇪 🇿 ッ❤️ তাকে সবাই পারভেজ নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@Farhana Ontora") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস পারভেজ এর বউ এর আইডি😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@AliUr ") || (event.body.toLowerCase() == "আলীউর")) {
     return api.sendMessage("🥰-আলীউর-🌺 আমার বস পারভেজ'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
